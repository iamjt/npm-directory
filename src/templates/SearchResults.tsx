         ...
         return( 
          <div className="search-result-item" key={index}>
            <div className="flex-row">
              <div className="search-result-header"><a target="_blank" rel="noreferrer" href={resultItem.package.links.npm?resultItem.package.links.npm:""}>{resultItem.package.name}</a></div>
